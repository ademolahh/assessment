...
contract VestedStakingTest is Test {
    ...
    function testSetUp() public view {
        ...
        IVestedStaking.StakingConfig memory scOne = staking.getStakingConfig(tokenOne);
        IVestedStaking.StakingConfig memory scTwo = staking.getStakingConfig(tokenTwo);
        ...
        assertEq(mERC20(tokenOne).name(), "Mock Token");
        assertEq(mERC20(tokenOne).symbol(), "MTK");
    }
    ...
    function testSingleDeposit() public {
        ...
        vm.expectRevert(IVestedStaking.StakingNotAllowed.selector);
        staking.deposit(address(1), amount);

        vm.expectRevert(IVestedStaking.AmountBelowMinimum.selector);
    ...
    function testMultipleDepositWithMultipleToken() public {
        ...
        IVestedStaking.Stake memory sOne = staking.getStakeInfo(iTwo, 1);
        IVestedStaking.Stake memory sTwo = staking.getStakeInfo(iTwo, 2);
    ...
    function testWithdrawal() public {
        ...
        vm.expectRevert(IVestedStaking.LockPeriodNotExpired.selector);
        ...
        vm.expectRevert(IVestedStaking.InsufficientBalance.selector);
